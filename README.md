...
- Demo: [giapha.thuongle.net](https://giapha.thuongle.net)
...
- **Demo công khai:** Trang demo tại `giapha.thuongle.net` sử dụng dữ liệu mẫu hư cấu, không chứa thông tin của người thật. Không nên nhập thông tin cá nhân thật vào trang demo.
